...
<div class="form-group has-feedback mb-3">
    <input type="email" class="form-control val" name="email" placeholder="EMAIL" required>
      <!-- <span class="glyphicon glyphicon-envelope form-control-feedback"></span> -->
</div>

<div class="form-group has-feedback mb-3">
    <input type="password" class="form-control val" name="password" placeholder="PASSWARD" required>
...
<div class="row">
      ...
      <a href="signup.php" style="display: block;margin: 10px 40px 10px 280px;font-size:20px;
        ...
        <a href="email-form.html" style="text-decoration: none;">Click here</a></p>

        <a href="password_forgot.php"><h4>I forgot my password</h4></a><br>
